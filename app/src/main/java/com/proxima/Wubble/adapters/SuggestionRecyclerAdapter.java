...
import com.proxima.Wubble.activities.NewWubbleActivity;
...
public class SuggestionRecyclerAdapter extends RecyclerView.Adapter<SuggestionRecyclerAdapter.ViewHolder> {
    ...
    public SuggestionRecyclerAdapter(Context context, List<MovieInformation> movieList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent changeIntent = new Intent(myContext, NewWubbleActivity.class);
                changeIntent.putExtra("id", movieList.get(position).id);
                changeIntent.putExtra("movieTitle", currentMovieName);
                changeIntent.putExtra("selected", true);
